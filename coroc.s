...
_coro_return:
  ...
  mov rcx, [rdi + 0x58]
  test rcx, rcx
  jz 3f  # _coro_return__not_delegate
...
_coro_continue:
  ...
  test rdx, rdx
  cmovnz rdi, rdx
  jnz 3b  # _coro_continue

  # if saved_rsp is blank, the coroutine is finished
  xchg [rdi + 0x10], rsp
  test rsp, rsp
  jnz 4f  # _coro_continue__coroutine_can_continue
...
4: _coro_continue__coroutine_can_continue:
